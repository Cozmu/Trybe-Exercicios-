...
*/
constructor(public name: string, protected birthDate: Date) { } /* mudou pra "protected"
 ser mudado pelas classes filhas */
...
class Bird extends Animal {
  ...
  showBirthDate() {
    console.log(this.birthDate); // ERRO => se fosse privado mas agora e "protected"
  }
}
