...
describe('Testando a API Cacau Trybe', function () {
    ...
    describe('Exercicio: Usando o método GET em /chocolates/total', function () {
        it('Retorne a quantidade total de chocolates que existem', async function () {
    ...
    describe('Exercicio: Usando o método GET em /chocolates/search?name=Mo', function () {
        it('Retorne os chocolates que contém o termo pesquisado', async function() {
